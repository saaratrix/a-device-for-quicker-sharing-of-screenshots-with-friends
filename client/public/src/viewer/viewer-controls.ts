...
import { viewingFailedToLoadEvent, viewingItemChangedEvent } from '../events/viewer-events.js';
...
class ViewerControls extends HTMLElement {
  ...
  private getPositionCSS(): [controlCSS: string, featuresCSS: string | ''] {
    ...
    switch (placement) {
      ...
      case 'page:right':
        ...
        break;
      // No need to do anything if left align as it's default value.
      default:
        side = '';
        break;
    }
  ...
  private onViewingFailedToLoad = (_: Event) => {
